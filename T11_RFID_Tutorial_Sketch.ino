...
byte blockcontent[16] = {"A______________"};//an array with 16 bytes to be written into one of the 64 card blocks is defined
...
void loop()
{
    ...
    readBlock(block, readblock);//read the block
